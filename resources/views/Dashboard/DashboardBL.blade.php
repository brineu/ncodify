    ...
    <div class="content-container">
        ...
        <div class="subscription-box">
            ...
            <div class="subscription-content">
                <img src="{{ asset('images/img/status.svg') }}" alt="Codify Logo" class="subscription-logo">
                <div class="subscription-info">
                    <p>Anda belum berlangganan Codify. Mulai berlangganan dan akses semua materi selamanya.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="main-content">
    ...
    <div class="activity-container">
        <img src="{{ asset('images/img/pic.png') }}" alt="Logo" class="activity-logo">
        <p class="no-activity">Anda belum memiliki aktivitas belajar di Codify</p>
    </div>
</div>
