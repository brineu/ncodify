...
<div class="main-content">
    ...
    <div class="course-row" id="row1">
        <div class="course-box" style="background-color: #D8D2F2;">
            <div class="box-content" onclick="window.location.href='/course/uiux/materi/ui';" style="cursor: pointer;">
        ...
        <div class="course-box" style="background-color: #8480C1;">
            <div class="box-content" onclick="window.location.href='/course/uiux/materi/ux';" style="cursor: pointer;">
