...
<div class="main-content">
    ...
    <div class="course-row" id="row1">
        <div class="course-box" style="background-color: #D8D2F2;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/html';" style="cursor: pointer;">
        ...
        <div class="course-box" style="background-color: #8480C1;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/css';" style="cursor: pointer;">
                <img src="{{ asset('images/img/gelap.svg') }}" alt="Play Logo" class="play-logo">
                <p>CSS</p>
            </div>
        </div>
        <div class="course-box" style="background-color: #D8D2F2;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/js';" style="cursor: pointer;">
                <img src="{{ asset('images/img/terang.svg') }}" alt="Play Logo" class="play-logo">
                <p>JavaScript</p>
            </div>
        </div>
        ...
        <div class="course-box" style="background-color: #8480C1;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/jquery';" style="cursor: pointer;">
                <img src="{{ asset('images/img/gelap.svg') }}" alt="Play Logo" class="play-logo">
                <p>JQuery</p>
            </div>
        </div>
        <div class="course-box" style="background-color: #D8D2F2;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/bootstrap';" style="cursor: pointer;">
                <img src="{{ asset('images/img/terang.svg') }}" alt="Play Logo" class="play-logo">
                <p>Bootstrap</p>
            </div>
        </div>
        ...
        <div class="course-box" style="background-color: #8480C1;">
            <div class="box-content" onclick="window.location.href='/course/webdev/materi/github';" style="cursor: pointer;">
                <img src="{{ asset('images/img/gelap.svg') }}" alt="Play Logo" class="play-logo">
                <p>Github</p>
            </div>
        </div>
