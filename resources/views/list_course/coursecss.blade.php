...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">CSS</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        ...
        <div class="course-item">
            <input type="checkbox" id="checkbox12" class="checkbox">
            <label for="checkbox12"></label>
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>Keyframe Animation</h3>
        </div>
        <div class="course-item">
            <input type="checkbox" id="checkbox13" class="checkbox">
            <label for="checkbox13"></label>
            <img src="{{ asset('images/gelap.png') }}" alt="">
            <h3>Media Query</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C;" href="{{ route('quiz.css', ['quizNumber' => 1]) }}">
            <input type="checkbox" id="checkbox14" class="checkbox">
