...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">JAVASCRIPT</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        ...
        <div class="course-item">
            ...
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>DOM Manipulation HTML Elements</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.js', ['quizNumber' => 1]) }}">
