...
<body>
    ...
    <div class="container">
        <div class="image-container">
            <img src="{{ asset('images/uiux.png') }}" alt="" width="140px" style="padding-left: 50px; padding-top: 40px;">
        </div>
        <div class="text-container">
            <h1 style="color: #1B0F4E;">UI/UX DESIGN</h1>
        </div>
    </div>    
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">USER EXPERIENCE (UX)</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        ...
        <div class="course-item">
            ...
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>Data Analysis and Metrics</h3>
        </div>
        <div class="course-item">
        ...
        <div class="course-item">
            ...
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>Iteraction and Improvement</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.ux', ['quizNumber' => 1]) }}">
            <input type="checkbox" id="checkbox11" class="checkbox">
