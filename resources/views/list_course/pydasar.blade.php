...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">DASAR-DASAR PYTHON</h1>
    </div>
    <br>
    <div>
...
<div class="course-list">
    ...
    <div class="course-item">
        ...
        <h3>Operations and Expressions</h3>
    </div>
    <div class="course-item">
    ...
    <a class="course-item" style="background-color: #2B187C;" href="{{ route('quiz.pydasar', ['quizNumber' => 1]) }}">
