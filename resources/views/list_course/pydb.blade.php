...
<head>
    ...
    <title>Pengoptimalan Code</title>
</head>
<body>
    <nav class="header">
        <ul class="flex-2">
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">MANAJEMEN DATABASE</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        <div class="course-item">
            ...
            <h3>Introduction SQL and SQL Lite</h3>
        </div>
        <div class="course-item">
            <input type="checkbox" id="checkbox2" class="checkbox">
            <label for="checkbox2"></label>
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>Interaction with Database</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.pydb', ['quizNumber' => 1]) }}">
