...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">FUNCTION</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        <div class="course-item">
            ...
            <h3>Creation and Function Calls</h3>
        </div>
        <div class="course-item">
            <input type="checkbox" id="checkbox2" class="checkbox">
            <label for="checkbox2"></label>
            <img src="{{ asset('images/terang.png') }}" alt="">
            <h3>Parameter and Return Values</h3>
        </div>
        <div class="course-item">
            <input type="checkbox" id="checkbox3" class="checkbox">
            <label for="checkbox3"></label>
            <img src="{{ asset('images/gelap.png') }}" alt="">
            <h3>Lambda and Recursive Functions</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C;" href="{{ route('quiz.pyfunc', ['quizNumber' => 1]) }}">
