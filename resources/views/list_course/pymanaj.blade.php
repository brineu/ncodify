...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">MANAJEMEN FILE</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        ...
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.pymanaj', ['quizNumber' => 1]) }}">
