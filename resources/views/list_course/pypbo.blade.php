...
<body>
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">PEMROGRAMAN BERORIENTASI OBJEK</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        ...
        <div class="course-item">
            ...
            <img src="{{ asset('images/gelap.png') }}" alt="">
            <h3>Understanding of OOP Concepts</h3>
        </div>
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.pypbo', ['quizNumber' => 1]) }}">
