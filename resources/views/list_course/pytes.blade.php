...
<head>
    ...
    <title>Pengujian dan Debugging</title>
</head>
<body>
    <nav class="header">
        <ul class="flex-2">
    ...
    <div>
        <h1 style="padding: 50px; color: #1B0F4E;">PENGUJIAN DAN DEBUGGING</h1>
    </div>
    <br>
    <div>
    ...
    <div class="course-list">
        <div class="course-item">
            ...
            <h3>Creation and Excution of Unite Tests</h3>
        </div>
        <div class="course-item">
        ...
        <a class="course-item" style="background-color: #2B187C; color: white;" href="{{ route('quiz.pytes', ['quizNumber' => 1]) }}">
